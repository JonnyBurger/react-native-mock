I forked the repository because the original repo [is not yet compatible with React 16](https://github.com/RealOrangeOne/react-native-mock/issues/129#issuecomment-392820838).
